...
void SetElement::JTS_DefaultHeader::DefaultHeaderRec::setParent(JTS_DefaultHeader* parent)
{
	m_parent = parent;
}

void SetElement::JTS_DefaultHeader::DefaultHeaderRec::setParentPresenceVector()
{
	if(m_parent != NULL )
	{
...
jUnsignedShortInteger SetElement::JTS_DefaultHeader::DefaultHeaderRec::getMessageID()
{
	return m_MessageID;
}

int SetElement::JTS_DefaultHeader::DefaultHeaderRec::setMessageID(jUnsignedShortInteger value)
{
	m_MessageID = value;
 ...
 * @return
 */
const unsigned int SetElement::JTS_DefaultHeader::DefaultHeaderRec::getSize()
{
	unsigned int size = 0;
...
void SetElement::JTS_DefaultHeader::DefaultHeaderRec::encode(unsigned char *bytes)
{
...
void SetElement::JTS_DefaultHeader::DefaultHeaderRec::decode(const unsigned char *bytes)
{
...
SetElement::JTS_DefaultHeader::DefaultHeaderRec &SetElement::JTS_DefaultHeader::DefaultHeaderRec::operator=(const DefaultHeaderRec &value)
{
...
bool SetElement::JTS_DefaultHeader::DefaultHeaderRec::operator==(const DefaultHeaderRec &value) const
{
...
SetElement::JTS_DefaultHeader::DefaultHeaderRec::DefaultHeaderRec()
{
	m_parent = NULL;
	m_MessageID = 0x041a;
}

SetElement::JTS_DefaultHeader::DefaultHeaderRec::DefaultHeaderRec(const DefaultHeaderRec &value)
{
...
SetElement::JTS_DefaultHeader::DefaultHeaderRec* const SetElement::JTS_DefaultHeader::getDefaultHeaderRec()
{
	return &m_DefaultHeaderRec;
}

int SetElement::JTS_DefaultHeader::setDefaultHeaderRec(const DefaultHeaderRec &value)
{
...
void SetElement::JTS_DefaultHeader::setParentPresenceVector()
{
 ...
 * @return
 */
const unsigned int SetElement::JTS_DefaultHeader::getSize()
{
	unsigned int size = 0;
...
void SetElement::JTS_DefaultHeader::encode(unsigned char *bytes)
{
...
void SetElement::JTS_DefaultHeader::decode(const unsigned char *bytes)
{
...
SetElement::JTS_DefaultHeader &SetElement::JTS_DefaultHeader::operator=(const JTS_DefaultHeader &value)
{
...
bool SetElement::JTS_DefaultHeader::operator==(const JTS_DefaultHeader &value) const
{
...
SetElement::JTS_DefaultHeader::JTS_DefaultHeader()
{
	m_DefaultHeaderRec.setParent(this);
	/// No Initialization of m_DefaultHeaderRec necessary.
}

SetElement::JTS_DefaultHeader::JTS_DefaultHeader(const JTS_DefaultHeader &value)
{
	/// Initiliaze the protected variables
	m_DefaultHeaderRec.setParent(this);
	/// No Initialization of m_DefaultHeaderRec necessary.
...
SetElement::JTS_DefaultHeader* const SetElement::getJTS_DefaultHeader()
{
	return &m_JTS_DefaultHeader;
}

int SetElement::setJTS_DefaultHeader(const JTS_DefaultHeader &value)
{
...
double SetElement::Body::SetElementSeq::ElementList::ElementRec::getNextUID()
{
	double value;
	
	double scaleFactor = ( 65534.0 - 0.0 ) / 65535.0;
	double bias = 0.0;
	
	value = m_NextUID * scaleFactor + bias;
	
	return value;
}

int SetElement::Body::SetElementSeq::ElementList::ElementRec::setNextUID(double value)
{
	if ((value >= 0.0) && (value <= 65534.0))
	{
		double scaleFactor = ( 65534.0 - 0.0 ) / 65535.0;
		double bias = 0.0;
		
		m_NextUID= (jUnsignedShortInteger)((value - bias) / scaleFactor);
		setParentPresenceVector();
		return 0;
	}
	return 1;
...
double SetElement::Body::SetElementSeq::ElementList::ElementRec::getPreviousUID()
{
	double value;
	...
	value = m_PreviousUID * scaleFactor + bias;
	
	return value;
}

int SetElement::Body::SetElementSeq::ElementList::ElementRec::setPreviousUID(double value)
{
	if ((value >= 0.0) && (value <= 65534.0))
	{
		double scaleFactor = ( 65534.0 - 0.0 ) / 65535.0;
		...
		m_PreviousUID= (jUnsignedShortInteger)((value - bias) / scaleFactor);
		setParentPresenceVector();
		return 0;
	}
	return 1;
...
double SetElement::Body::SetElementSeq::ElementList::ElementRec::getElementUID()
{
	double value;
...
int SetElement::Body::SetElementSeq::ElementList::ElementRec::setElementUID(double value)
{
...
const jUnsignedByte SetElement::Body::SetElementSeq::ElementList::ElementRec::ElementData::getLength() const
{
	return m_Length;
}
...
int SetElement::Body::SetElementSeq::ElementList::ElementRec::ElementData::set(jUnsignedByte format, jUnsignedByte length, unsigned char *data)
{
	if ((format == 0))
	{
		m_Format = format;
...
void SetElement::Body::SetElementSeq::ElementList::ElementRec::ElementData::encode(unsigned char *bytes)
{
	...
	jUnsignedByte m_LengthTemp;
	
	m_LengthTemp = JSIDL_v_1_0::correctEndianness(m_Length);
	memcpy(bytes+pos, &m_LengthTemp, sizeof(jUnsignedByte));
	pos += sizeof(jUnsignedByte);
...
void SetElement::Body::SetElementSeq::ElementList::ElementRec::ElementData::decode(const unsigned char *bytes)
{
	...
	memcpy(&m_LengthTemp, bytes+pos, sizeof(jUnsignedByte));
...
{
	if (m_ElementRec.size() !=  value.m_ElementRec.size())
	{
		return false;
	}
