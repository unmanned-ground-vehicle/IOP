#include "urn__jaus__jss__mobility__pfmgmtclient_1_0/Messages/ReportIdentification.h"
...
{
	if (((value >= 10002) && (value <= 20000)) || ((value >= 20002) && (value <= 30000)) || ((value >= 30002) && (value <= 40000)) || ((value >= 40002) && (value <= 50000)) || ((value >= 50002) && (value <= 60000)) || ((value >= 60002) && (value <= 65535)) || (value == 30001) || (value == 40001) || (value == 50001) || (value == 60001) || (value == 0) || (value == 10001) || (value == 20001))
	{
		m_Type = value;
		setParentPresenceVector();
		return 0;
